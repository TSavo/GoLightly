...
func NewRandomBreeder(popSize int, programLen int, is *InstructionSet) *RandomBreeder {
...
func NewMutationBreeder(popSize int, mutationChance float64, is *InstructionSet) MutationBreeder {
